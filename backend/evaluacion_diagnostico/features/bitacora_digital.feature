...
#  Escenario: Categorización de un episodio de cefalea basado en los síntomas registrados en pacientes
#    Dado que un paciente ha ingresado datos para un nuevo episodio de cefalea con las siguientes características:
#      | Migrana sin aura          | 6 | Severa   | Unilateral | Pulsatil | Si | Si | Si | Si | No | Ninguno              | 0  | Si | Si |
#      | Migrana con aura          | 4 | Moderada | Unilateral | Pulsatil | Si | No | Si | Si | Si | Visuales, Sensitivos | 30 | Si | Si |
#      | Cefalea de tipo tensional | 2 | Leve     | Bilateral  | Opresivo | No | No | No | Si | No | Ninguno              | 0  | No | No |
...
#    Y el episodio se guarda en la bitácora del paciente
  ...
  Esquema del escenario: Categorización de un episodio de cefalea basado en los síntomas registrados en pacientes
    Dado que un paciente ha ingresado datos para un nuevo episodio de cefalea con las siguientes características
